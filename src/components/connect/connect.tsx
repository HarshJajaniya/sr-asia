...
const currentOpenings = [
  {
    ...
    location: "Ghaziabad",
    type: "Full-time",
    description: "Build and maintain strong client relationships while driving business growth through effective communication and service delivery.",
  },
  {
    id: 2,
    ...
    location: "Ghaziabad",
    type: "Full-time",
    description: "Oversee the end-to-end tendering process, from identifying opportunities to submitting proposals, ensuring compliance and competitiveness.",
  },
  {
    id: 3,
    ...
    location: "Ghaziabad",
    type: "Full-time",
    description: "Conduct in-depth research and data analysis to provide actionable insights that support strategic decision-making.",
  },
...
const internships = [
  {
    ...
    location: "Ghaziabad",
    type: "Internship",
    description: "Manage and nurture client relationships to ensure satisfaction, retention, and long-term partnership growth.",
  },
  {
    id: 102,
  ...
  },
   {
    ...
    location: "Ghaziabad",
    type: "Internship",
    description: "Assist in various HR functions, including recruitment, onboarding, and employee engagement initiatives.",
  },
   {
    id: 104,
    ...
    location: "Ghaziabad",
    type: "Internship",
    description: "Assist in the tendering process, including bid preparation and submission.",
  },
   {
    id: 105,
    title: "Marketing ",
    location: "Ghaziabad",
    type: "Internship",
    description: "Support marketing campaigns and initiatives to enhance brand visibility and engagement.",
  },
   {
    id: 105,
    title: "Research Analyst",
...
function ApplicationForm({ jobId, onClose }: { jobId: number; onClose: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ name: "", email: "", experience: "", ctc: "", resume: null })
      onClose()
    } catch (err) {
      console.error(err)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 mt-4 bg-white p-4 rounded shadow">
  ...
  <div className="flex items-center space-x-4">
    ...
    <span className="text-sm text-gray-700">
      ...
      <div className="flex justify-between">
        <button type="submit" disabled={loading} className="bg-[#072328] text-white px-4 py-2 rounded">
          {loading ? "Submitting..." : "Submit Application"}
        </button>
        <button type="button" onClick={onClose} className="text-sm text-red-600 underline">
          Cancel
        </button>
      </div>
    </form>
            ...
            <Card key={job.id} className="bg-sky-100 border-sky-200">
              <CardContent className="p-4">
                ...
                {selectedJobId === job.id && (
                  <ApplicationForm jobId={job.id} onClose={() => setSelectedJobId(null)} />
                )}
              </CardContent>
            </Card>
          ))}
