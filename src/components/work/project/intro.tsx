  ...
  return (
    <div className="min-h-screen mb-[75px]">
      <div className="max-w-8xl mx-[20px]">
        ...
        {/* What's Next Section */}
        <section className="mb-16">
          <h2 className="text-[tertiary/700] text-3xl font-bold mb-6">What's next for Project Implementation?</h2>
          <p className="text-[#246875] leading-relaxed mb-8">
         The future of project implementation lies in community-led design, adaptive delivery models, and tech-enabled monitoring. As development challenges grow more interconnected, SR Asia is evolving its approach to ensure that projects are not only well-executed but also locally relevant, scalable, and sustainable. We are integrating real-time data tools, participatory methods, and climate-resilient frameworks to enhance impact across sectors. From skills training to ecological restoration, our next-gen implementation strategies focus on co-creation, evidence, and lasting change — ensuring projects don’t just meet goals, but transform lives.
          </p>
