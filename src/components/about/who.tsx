      ...
      <div className="max-w-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-4 text-sm text-gray-700 leading-relaxed" ref={aboutTextRef}>
            <p>
              SR Asia (Social Responsibility Asia) is an ISO 9001-certified, not-for-profit organization established in 2012. With a presence across six Asian countries and projects in over 26 Indian states, we work at the intersection of sustainability, governance, and social equity.
We partner with corporates, PSUs, governments, and development institutions to drive evidence-based development, ESG integration, and inclusive impact. Our approach blends policy expertise, ground-level execution, and innovation to build a more sustainable and equitable future for Asia.
            </p>
