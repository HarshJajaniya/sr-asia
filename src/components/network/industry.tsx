      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="space-y-8">
          {industryEntries.map((entry, index) => (
            <div
              key={index}
              className="grid grid-cols-[auto_1fr_auto] gap-4 items-start p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
            >
              <div className="text-lg font-medium text-gray-700 pr-4">
                {entry.year}
              </div>
